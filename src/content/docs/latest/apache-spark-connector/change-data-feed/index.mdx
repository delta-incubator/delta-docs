...
-- path based tables
SELECT \* FROM table_changes_by_path('\\path', '2021-04-21 05:45:46')`} lang="sql" />
...
.option("readChangeFeed", "true") \\
.option("startingTimestamp", '2021-04-21 05:45:46') \\
.load("pathToMyDeltaTable")`} lang="python" />
...
.option("readChangeFeed", "true")
.option("startingTimestamp", "2021-04-21 05:45:46")
.load("pathToMyDeltaTable")`} lang="scala" />
...
spark.readStream.format("delta") \\
.option("readChangeFeed", "true") \\
.table("myDeltaTable")`} lang="python" />
