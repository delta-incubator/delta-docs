...
- The command runs with [automatic schema evolution](/latest/delta-update#merge-schema-evolution) enabled
...
See [Drop Delta table features](/latest/delta-drop-feature) for more information on dropping Delta table features.
