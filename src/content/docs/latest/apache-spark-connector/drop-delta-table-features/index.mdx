...
- `typeWidening-preview`. See [Delta type widening](/latest/apache-spark-connector/type-widening/). Type widening is available in preview in Delta Lake 3.2.0 and above.
...
- `inCommitTimestamp`. See [In-Commit Timestamps](/latest/apache-spark-connector/table-batch-operations/#in-commit-timestamps). In-Commit Timestamp is available in Delta Lake 3.3.0 and above.
