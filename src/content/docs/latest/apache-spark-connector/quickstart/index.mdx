...
<Aside type="note">
  [Delta Lake 4.0
  Preview](https://github.com/delta-io/delta/releases/tag/v4.0.0rc1) is
  released! See the 4.0 Preview documentation
  [here](https://docs.delta.io/4.0.0-preview/index.html).
</Aside>
...
<Aside type="caution" title="Important!">
  ...
  [release compatibility matrix](link-to-compatibility-matrix) for details.
</Aside>
...
<Aside type="note">
  ...
  configuration](delta-storage.md).
</Aside>
